...
assert(luna.math.round(3.6) == 4)
assert(luna.math.round(3.2) == 3)
assert(luna.math.round(3.14159, 0.1) == 3.1)
assert(luna.math.round(3.678, 0.1) == 3.7)
assert(luna.math.round(3.14159, 0.01) == 3.14)
assert(luna.math.round(3.678, 0.01) == 3.68)
assert(luna.math.round(3.14159, 0.001) == 3.142)
assert(luna.math.round(3.678, 0.001) == 3.678)
assert(luna.math.round(35, 10) == 40)
assert(luna.math.round(32, 10) == 30)
